...
@section('content')
    <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-end gap-3 mb-4">
        ...
        @if ($canManage)
            <button class="btn btn-brand btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#addDeworming"><i class="bi bi-plus-lg me-1"></i>Add record</button>
        @elseif ($pets->isEmpty())
